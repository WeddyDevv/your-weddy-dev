        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-playfair text-2xl font-semibold">Eternal Moments</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/80">
              ...
              <li><a href="#" className="hover:text-rose-gold transition-colors">Guest Information</a></li>
            </ul>
          </div>
